...
<div class="container">
    ...
    <form action="Client" method="post">
        <label for="sqlCommand">Enter SQL Command (Only SELECT queries are allowed):</label><br>
        <textarea id="sqlCommand" name="sqlCommand" placeholder="Enter your SQL command here" cols=60 rows=8><%=sqlStatement%></textarea><br>
        <br>
